...
var layer_list = [
  {
    image: img1,
    src: '/images/parallax-illustrations/golden-forest/bg.png',
    z_index: -1.5,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img2,
    src: '/images/parallax-illustrations/golden-forest/wood.png',
    z_index: -1,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img3,
    src: '/images/parallax-illustrations/golden-forest/feline.png',
    z_index: -0.8,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img4,
    src: '/images/parallax-illustrations/golden-forest/overlay.png',
    z_index: -0.8,
    position: { x: 0, y: 0 },
    blend: 'overlay',
    opacity: 1,
  ...
  {
    image: img5,
    src: '/images/parallax-illustrations/golden-forest/frame.png',
    z_index: 0,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img6,
    src: '/images/parallax-illustrations/golden-forest/top-plant.png',
    z_index: 0.5,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img7,
    src: '/images/parallax-illustrations/golden-forest/sign.png',
    z_index: 0.8,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 0.5,
