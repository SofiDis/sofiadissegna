...
var loaded = false;
var load_counter = 0;
// initialize imagef for layer (same number of the image)
var img1 = new Image();
var img2 = new Image();
var img3 = new Image();
var img4 = new Image();
...
// create a list of layer objects (fare per ogni immagine)
// dividere gli oggetti che devono entrare nella pagina (- z_index)
// da quelli che vanno fuori (+ z_index)
// a z_index 0 c'è la maschera
var layer_list = [
  {
    image: img1,
    src: '/images/parallax-illustrations/follow-me/sky.png',
    z_index: -0.6,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img15,
    src: '/images/parallax-illustrations/follow-me/moonlight.png',
    z_index: -0.5,
    position: { x: 0, y: 0 },
    blend: 'overlay',
    opacity: 0.4,
  ...
  {
    image: img2,
    src: '/images/parallax-illustrations/follow-me/mountains-s.png',
    z_index: -0.5,
    position: { x: 0, y: 0 },
    blend: 'multiply',
    opacity: 1,
  ...
  {
    image: img3,
    src: '/images/parallax-illustrations/follow-me/mountains.png',
    z_index: 0,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img4,
    src: '/images/parallax-illustrations/follow-me/castle.png',
    z_index: 0,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img5,
    src: '/images/parallax-illustrations/follow-me/plant2.png',
    z_index: 0.1,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img6,
    src: '/images/parallax-illustrations/follow-me/plant.png',
    z_index: 0.2,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img7,
    src: '/images/parallax-illustrations/follow-me/tree.png',
    z_index: 0.3,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img8,
    src: '/images/parallax-illustrations/follow-me/plant3.png',
    z_index: 0.4,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img9,
    src: '/images/parallax-illustrations/follow-me/girl-s.png',
    z_index: 0.5,
    position: { x: 0, y: 0 },
    blend: 'multiply',
    opacity: 0.3,
  ...
  {
    image: img10,
    src: '/images/parallax-illustrations/follow-me/girl.png',
    z_index: 0.75,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img11,
    src: '/images/parallax-illustrations/follow-me/follow-s.png',
    z_index: 0.5,
    position: { x: 0, y: 0 },
    blend: 'multiply',
    opacity: 0.3,
  ...
  {
    image: img12,
    src: '/images/parallax-illustrations/follow-me/follow.png',
    z_index: 0.75,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img13,
    src: '/images/parallax-illustrations/follow-me/star.png',
    z_index: 1.2,
    position: { x: 0, y: 0 },
    blend: 'overlay',
    opacity: 0.5,
  ...
  {
    image: img14,
    src: '/images/parallax-illustrations/follow-me/star2.png',
    z_index: 1.2,
    position: { x: 0, y: 0 },
    blend: 'overlay',
    opacity: 1,
