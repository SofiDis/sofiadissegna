...
var onde_s = new Image();
var onde = new Image();
var mask = new Image();
var fall_s = new Image();
var fall = new Image();
var glow_s = new Image();
var glow = new Image();
...
var layer_list = [
  {
    image: background,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers-2.png',
    z_index: -0.75,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: onde_s,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers-3.png',
    z_index: -0.5,
    position: { x: 0, y: 0 },
    blend: 'multiply',
    opacity: 1,
  ...
  {
    image: onde,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers-4.png',
    z_index: -0.25,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: mask,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers_mask-5.png',
    z_index: 0,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: fall_s,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers-6.png',
    z_index: 0.25,
    position: { x: 0, y: 0 },
    blend: 'multiply',
    opacity: 1,
  ...
  {
    image: fall,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers-7.png',
    z_index: 0.5,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: glow_s,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers-8.png',
    z_index: 0.75,
    position: { x: 0, y: 0 },
    blend: 'multiply',
    opacity: 1,
  ...
  {
    image: glow,
    src: '/images/parallax-illustrations/fallen/Fall_Parallax_Layers-9.png',
    z_index: 1,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
