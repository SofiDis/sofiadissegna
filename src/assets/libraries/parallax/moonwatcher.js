...
var layer_list = [
  {
    image: img1,
    src: '/images/parallax-illustrations/moon-watcher/bg.png',
    z_index: -1.5,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img2,
    src: '/images/parallax-illustrations/moon-watcher/mountains1.png',
    z_index: -1,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img3,
    src: '/images/parallax-illustrations/moon-watcher/mountains2.png',
    z_index: -0.8,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img4,
    src: '/images/parallax-illustrations/moon-watcher/hills.png',
    z_index: -0.5,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img5,
    src: '/images/parallax-illustrations/moon-watcher/mask.png',
    z_index: 0,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img6,
    src: '/images/parallax-illustrations/moon-watcher/moon.png',
    z_index: 0.2,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img7,
    src: '/images/parallax-illustrations/moon-watcher/wolf-s.png',
    z_index: 0.8,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 0.5,
  ...
  {
    image: img8,
    src: '/images/parallax-illustrations/moon-watcher/wolf.png',
    z_index: 0.8,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img9,
    src: '/images/parallax-illustrations/moon-watcher/snow.png',
    z_index: 1.5,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: img10,
    src: '/images/parallax-illustrations/moon-watcher/overlay.png',
    z_index: 1.6,
    position: { x: 0, y: 0 },
    blend: 'overlay',
    opacity: 0,
